...
namespace DynamicWin.Main
{
    public class RendererMain : SKElement
    {
        ...
        public RendererMain()
        {
            ...
            edgeGlowEffect = new EdgeGlowEffect();
            m.Init();
        ...
        private void Update()
        {
            ...
            edgeGlowEffect.IsActive = islandObject.IsActiveGlow;
            edgeGlowEffect.Update(DeltaTime);
        ...
        protected override void OnPaintSurface(SKPaintSurfaceEventArgs e)
        {
            ...
            float logicalWidth = (float)MainForm.Instance.Width;
            float logicalHeight = (float)MainForm.Instance.Height;

            edgeGlowEffect.Draw(canvas, logicalWidth, logicalHeight, islandObject);
