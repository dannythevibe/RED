...
namespace DynamicWin.Main
{
    public partial class MainForm : Window
    {
        ...
        public MainForm()
        {
            ...
            // and excludes the window from all screenshots/screen capture (RED Stealth Mode)
            ...
            this.Loaded += (s, e) =>
            {
                ...
                // Exclude window from screenshots and screen recordings (Invincible Stealth Mode)
                try
                {
                ...
                {
                    System.Diagnostics.Debug.WriteLine($"⚠️ DynamicWin: Failed to set WDA_EXCLUDEFROMCAPTURE: {ex.Message}");
                }
            };
            ...
            // Ignite RED Bridge Client Socket
            RedBridgeClient.Start();
